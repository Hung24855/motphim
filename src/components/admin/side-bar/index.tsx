            ...
            <div className="h-full overflow-y-auto bg-gray-50 px-3 py-4">
                <ul className="space-y-2 font-medium">
                    ...
                    <li onClick={() => logout_action()}>
                        <button className="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 w-full">
                            <svg
                            ...
                            <span className="ms-3 flex-1 whitespace-nowrap text-left" >Đăng xuất</span>
                        </button>
                    </li>
                </ul>
            </div>

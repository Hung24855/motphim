                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <details className="group w-full">
                                <summary className="list-none flex w-full items-center rounded-lg p-2 text-base text-gray-900 transition duration-75 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                    <svg
